/* =========================================================
   ...
   Samme begrepssett som Begrepsmatch, kopiert hit som sin egen
   fil slik at spillene forblir uavhengige av hverandre. Denne
   fila kjenner ikke til spill-motoren i det hele tatt — den
   beskriver bare et emne og spørsmålene som hører til.
